...
1. Search for "pushmix web notifications".
1. Click "Install Now".
...
For more details on this plugin read [here](https://github.com/pushmix/wordpress-web-notifications)
...
3. Action Buttons and Large Image
4. Opt in Prompt
